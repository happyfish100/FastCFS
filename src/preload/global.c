...
static int dlsym_all()
{
    ...
    g_fcfs_preload_global_vars.pwritev = dlsym_one("pwritev", true);
    ...
    g_fcfs_preload_global_vars.preadv = dlsym_one("preadv", true);
    g_fcfs_preload_global_vars.lseek = dlsym_one("lseek", true);
    g_fcfs_preload_global_vars.fallocate = dlsym_one("fallocate", true);
    ...
    g_fcfs_preload_global_vars.mknodat = dlsym_two(
            "mknodat", "__xmknodat", true);
    g_fcfs_preload_global_vars.mkfifo = dlsym_one("mkfifo", true);
    g_fcfs_preload_global_vars.mkfifoat = dlsym_one("mkfifoat", true);
    ...
    g_fcfs_preload_global_vars.futimesat = dlsym_one("futimesat", true);
    ...
    g_fcfs_preload_global_vars.renameat2 = dlsym_one("renameat2", true);
    ...
    g_fcfs_preload_global_vars.lsetxattr = dlsym_one("lsetxattr", true);
    g_fcfs_preload_global_vars.fsetxattr = dlsym_one("fsetxattr", true);
    g_fcfs_preload_global_vars.getxattr = dlsym_one("getxattr", true);
    g_fcfs_preload_global_vars.lgetxattr = dlsym_one("lgetxattr", true);
    ...
    g_fcfs_preload_global_vars.llistxattr = dlsym_one("llistxattr", true);
    ...
    g_fcfs_preload_global_vars.lremovexattr = dlsym_one("lremovexattr", true);
    ...
    g_fcfs_preload_global_vars.scandirat = dlsym_one("scandirat", true);
