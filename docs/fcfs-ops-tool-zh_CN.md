...
***注：推荐使用 5.4.0 及以后的版本用于生成集群配置文件，尤其是vote（投票）模块。***
...
> ./conf_tpl_tar.sh 5.4.0 update

将在当前目录创建配置模版压缩包文件 **conf.5.4.0.tpl.tar.gz**。
