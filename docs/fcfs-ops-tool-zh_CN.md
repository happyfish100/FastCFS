...
***注：推荐使用 5.3.1 及以后的版本用于生成集群配置文件，尤其是vote（投票）模块。***
...
> ./conf_tpl_tar.sh 5.3.1 update

将在当前目录创建配置模版压缩包文件 **conf.5.3.1.tpl.tar.gz**。
