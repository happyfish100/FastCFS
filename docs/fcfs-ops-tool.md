...
***Tip：Use version 5.0.0 and later for deploy.***
...
***Tip：Use version 5.0.0 and later for crearte config files, especially for vote server.***
...
> ./conf_tpl_tar.sh 5.0.0 update

It will create tar file **conf.5.0.0.tpl.tar.gz** in current dir.
