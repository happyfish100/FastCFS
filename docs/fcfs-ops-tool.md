...
***Tip：Use version 4.1.0 and later for deploy.***
...
***Tip：Use version 4.1.0 and later for crearte config files, especially for vote server.***
...
It will create tar file **conf.4.1.0.tpl.tar.gz** in current dir.
