...
***Tip：Use version 3.6.2 and later for crearte config files, especially for vote server.***
...
> ./conf_tpl_tar.sh 3.6.2 update

It will create tar file **conf.3.6.2.tpl.tar.gz** in current dir.
