...
***Tip：Use version V5.5.2 and later for create config files, especially for vote server.***
...
> ./conf_tpl_tar.sh V5.5.2 update

It will create tar file **conf.V5.5.2.tpl.tar.gz** in current dir.
