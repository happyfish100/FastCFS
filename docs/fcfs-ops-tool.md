...
***Tip：Use version 5.5.1 and later for create config files, especially for vote server.***
...
> ./conf_tpl_tar.sh 5.5.1 update

It will create tar file **conf.5.5.1.tpl.tar.gz** in current dir.
