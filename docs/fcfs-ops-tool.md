...
***Tip：Use version 4.2.0 and later for deploy.***
...
***Tip：Use version 4.2.0 and later for crearte config files, especially for vote server.***
...
It will create tar file **conf.4.2.0.tpl.tar.gz** in current dir.
